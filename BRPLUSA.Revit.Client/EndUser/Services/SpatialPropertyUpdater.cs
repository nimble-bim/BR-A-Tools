...
namespace BRPLUSA.Revit.Client.EndUser.Services
{
    ...
    //    private IEnumerable<RevitSpace> GetChangedSpaces(UpdaterData data)
    //    {
    //        var modified = data.GetModifiedElementIds();

    //        var doc = data.GetDocument();
    //        return modified.Select(x => doc.GetElement(x)).Cast<RevitSpace>();
    //    }

    //    private static bool IsCurrentlyTracked(RevitSpace space)
    //    {
    //        return _db.IsCurrentlyTracked(space);
    //    }

    //    private static bool NeedsUpdate(RevitSpace space)
    //    {
    //        return _db.NeedsUpdate(space);
    //    }

    //    private void UpdateSpace(RevitSpace space)
    //    {
    ...
    //    private Space UpdateRevitDocument(RevitSpace space)
    //    {
