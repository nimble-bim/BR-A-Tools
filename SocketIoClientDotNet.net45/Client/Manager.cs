...
namespace Quobject.SocketIoClientDotNet.Client
{
    public class Manager : Emitter
    {
        ...
        private EngineIoClientDotNet.Client.Socket.Options Opts;
        private bool AutoConnect;
        private HashSet<Socket> OpeningSockets;
        /*package*/

        public EngineIoClientDotNet.Client.Socket EngineSocket;
        ...
        private Manager Open(IOpenCallback fn)
        {
            ...
            EngineIoClientDotNet.Client.Socket socket = EngineSocket;
    ...
    public class Engine : EngineIoClientDotNet.Client.Socket
    {
    ...
    public class Options : EngineIoClientDotNet.Client.Socket.Options
    {
